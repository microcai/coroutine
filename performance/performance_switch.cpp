...
{
    boost::coroutines::coroutine< void >::pull_type c( fn_void, preserve);
...
{
    boost::coroutines::coroutine< int >::pull_type c( fn_int, preserve);
...
{
    boost::coroutines::coroutine< X >::pull_type c( fn_x, preserve);
